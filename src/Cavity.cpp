...
// Cavity::Cavity(Molecule const &molecule, CellFilteringOptions const
// cell_opts) {
...
//     double const vol =
//         volume(p0, ip1, ip2, ip3) - sphere_sector_vol(p0, ip1, ip2, ip3,
//         vdw0);
//     _outer_volume += vol;
...
//     double const vol2 =
//         volume(p1, ip2, ip3, ip4) - sphere_sector_vol(p1, ip2, ip3, ip4,
//         vdw1);

//     double const vol3 =
//         volume(p1, ip3, ip4, ip5) - sphere_sector_vol(p1, ip3, ip4, ip5,
//         vdw1);
//     _outer_volume += vol1 + vol2 + vol3;
...
// void Cavity::add_border_penta(Point const &p0, Point const &p1, Point const
// &p2,
...
//     double const vol3 =
//         volume(p2, ip3, ip4, ip5) - sphere_sector_vol(p2, ip3, ip4, ip5,
//         vdw2);
