...
CConvexHull create_cconvex_hull(
    ...
    case IncludedAreaOptions::IAOption::residue:
        return CConvexHull(protein, IA_opts._resn_proto, ResidueTag());
    case IncludedAreaOptions::IAOption::atom:
        return CConvexHull(protein, IA_opts._atom_proto, AtomTag());
    case IncludedAreaOptions::IAOption::sphere:
        return CConvexHull(IA_opts._sphere_proto, SphereTag());
    case IncludedAreaOptions::IAOption::cylinder:
        return CConvexHull(IA_opts._cylinder_proto, CylinderTag());
    case IncludedAreaOptions::IAOption::prism:
        return CConvexHull(IA_opts._prism_proto, PrismTag());
    case IncludedAreaOptions::IAOption::file:
        return CConvexHull(IA_opts._filename, FileTag());
...
CConvexHull::CConvexHull(
    ...
    try {
        run_cconvex_hull(incl_area_points);
...
CConvexHull::CConvexHull(std::string const &sphere_proto, SphereTag) {
...
CConvexHull::CConvexHull(std::string const &cylinder_proto, CylinderTag) {
...
CConvexHull::CConvexHull(std::string const &prism_proto, PrismTag) {
...
CConvexHull::CConvexHull(std::string const &filename, FileTag) {
