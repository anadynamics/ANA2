...
cmd.load("convex_hull_testing_3.pdb")
cmd.hide("sticks", "convex_hull_testing_3")
cmd.show("lines", "convex_hull_testing_3")
cmd.color("yellow", "convex_hull_testing_3")
cmd.set_view (\
...
cmd.png("quickstart_4.png", width=400, height=300, dpi=100, ray=1)
