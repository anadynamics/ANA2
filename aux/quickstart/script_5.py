...
cmd.load("convex_hull_testing_4.pdb")
cmd.hide("sticks", "convex_hull_testing_4")
cmd.show("lines", "convex_hull_testing_4")
cmd.color("purple", "convex_hull_testing_4")
cmd.set_view (\
...
cmd.png("quickstart_5.png", width=400, height=300, dpi=100, ray=1)
