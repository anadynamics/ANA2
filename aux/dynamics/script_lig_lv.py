...
cmd.load("4xcp_lv.pdb")
cmd.color("density", "4xcp_lv")
cmd.load("lig_lv_cavity_1.pdb")
cmd.color("lightblue", "lig_lv_cavity_1")
...
cmd.png("dynamics_lig_lv.png", width=500, height=400, dpi=100, ray=1)
